...
//         private Zone(MapV1 map, int zone) {
//             this.map = map;
//             this.zoneID = zone;
//         }
...
//                 } else {
//                     if (tile < 10) {
//                         if (mob.level >= 50) { // rớt đá cấp 4, 5 và 6
//                             List<Integer> listDa = Arrays.asList(4, 5, 6);
//                             idItem = UTPKoolVN.getRandomList(listDa);
//                         } else if (mob.level >= 40) { // rớt đá cấp 4 và 5
//                             List<Integer> listDa = Arrays.asList(4, 5);
//                             idItem = UTPKoolVN.getRandomList(listDa);
//                         } else if (mob.level >= 30) { // rớt đá cấp 3 và 4
//                             List<Integer> listDa = Arrays.asList(3, 4);
//                             idItem = UTPKoolVN.getRandomList(listDa);
//                         } else if (mob.level >= 20) { // rớt đá cấp 2 và 3
//                             List<Integer> listDa = Arrays.asList(2, 3);
//                             idItem = UTPKoolVN.getRandomList(listDa);
//                         }
//                         item = new Item(idItem);
//                     } else if (tile < 50) { // tăng tỷ lệ từ 40% lên 50%
//                         int backhoa = 0;
//                         if (mob.level >= 50) { // rớt bạc khóa 2000-2500
//                             backhoa = Utlis.nextInt(2000, 2500);
//                         } else if (mob.level >= 40) { // rớt bạc khóa 1500-2000
//                             backhoa = Utlis.nextInt(1500, 2000);
//                         } else if (mob.level >= 30) { // rớt bạc khóa 1000-1500
//                             backhoa = Utlis.nextInt(1000, 1500);
//                         } else if (mob.level >= 20) { // rớt bạc khóa 500-1000
//                             backhoa = Utlis.nextInt(500, 1000);
//                         }
